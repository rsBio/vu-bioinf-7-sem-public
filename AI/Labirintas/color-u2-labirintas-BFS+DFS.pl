...
sub _eiti_platyn {
    ...
    my @langeliai_tikrinimui = ('bangos_pabaiga');
    push @langeliai_tikrinimui, [ $y, $x ];
 #   push @langeliai_tikrinimui, 'bangos_pabaiga';
    print "\n";
 #   print ' ' x 3 x ($bangos_nr - 1) . "Uzdaroma x = $x, y = $y\n";    
 #   print "BANGA nr. $bangos_nr:\n";
    my $bang;    
...
#>                ('*' x 3)
		...
		printf "  [Atidaryta: %2d]", ++ $atidarytu_sk;
            }
            print "\n";
        }
